package assignments.no3;

import assignments.no3.adapter.*;
import assignments.no3.builder.*;
import assignments.no3.decorator.*;
import assignments.no3.factory.FactoryPost;
import assignments.no3.factory.Post;
import assignments.no3.factory.Type;
import assignments.no3.flyweight.BadgeDetails;
import assignments.no3.flyweight.BadgeFactory;
import assignments.no3.flyweight.BadgeType;
import assignments.no3.flyweight.Model3D;
import assignments.no3.prototype.Badge;
import assignments.no3.prototype.ColourStyle;
import assignments.no3.proxy.PictureUpload;
import assignments.no3.proxy.ProfilePicture;
import assignments.no3.proxy.ProxyPictureUpload;
import assignments.no3.proxy.exception.UploadFailedException;
import assignments.no3.singleton.Neo4JConnection;
...
public class TestAssignment {
    public static void main(String[] args) {
        ...
        assignments.no3.composite.Challenge challenge = new assignments.no3.composite.Challenge("No car");
        challenge.addNode(new assignments.no3.composite.Stage("2 days per week no car", 4));
        challenge.addNode(new assignments.no3.composite.Stage("3 days per week no car", 6));
        challenge.addNode(new assignments.no3.composite.Stage("4 days per week no car", 8));
        System.out.println("Total weeks to complete all stages: " + challenge.getCondition());
        assignments.no3.composite.Challenge expertChallenge = new assignments.no3.composite.Challenge("No car expert");
