package seminar.assignments.no3;

import seminar.assignments.no3.adapter.*;
import seminar.assignments.no3.builder.*;
import seminar.assignments.no3.decorator.*;
import seminar.assignments.no3.factory.FactoryPost;
import seminar.assignments.no3.factory.Post;
import seminar.assignments.no3.factory.Type;
import seminar.assignments.no3.flyweight.BadgeDetails;
import seminar.assignments.no3.flyweight.BadgeFactory;
import seminar.assignments.no3.flyweight.BadgeType;
import seminar.assignments.no3.flyweight.Model3D;
import seminar.assignments.no3.prototype.Badge;
import seminar.assignments.no3.prototype.ColourStyle;
import seminar.assignments.no3.proxy.PictureUpload;
import seminar.assignments.no3.proxy.ProfilePicture;
import seminar.assignments.no3.proxy.ProxyPictureUpload;
import seminar.assignments.no3.proxy.exception.UploadFailedException;
import seminar.assignments.no3.singleton.Neo4JConnection;
...
public class TestAssignment {
    public static void main(String[] args) {
        ...
        seminar.assignments.no3.composite.Challenge challenge = new seminar.assignments.no3.composite.Challenge("No car");
        challenge.addNode(new seminar.assignments.no3.composite.Stage("2 days per week no car", 4));
        challenge.addNode(new seminar.assignments.no3.composite.Stage("3 days per week no car", 6));
        challenge.addNode(new seminar.assignments.no3.composite.Stage("4 days per week no car", 8));
        System.out.println("Total weeks to complete all stages: " + challenge.getCondition());
        seminar.assignments.no3.composite.Challenge expertChallenge = new seminar.assignments.no3.composite.Challenge("No car expert");
